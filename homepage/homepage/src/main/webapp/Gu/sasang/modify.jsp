...
<script>
	...
	$(document).ready(function () {
	    ...
	    $(".listBtn").on("click", function () {
	        self.location = "../sasang/sasang?page=${criteria.page}&criteria.perPageNum";
...
<div class="jumbotron">
  <h1 class="display-3">sasang지도자리</h1>
  <p class="lead">준희 화이팅 </p>
</div>

 <div class="col-lg-12">
      <form role="form" id ="writeForm" method="post" action ="${path}/sasang/modify">
