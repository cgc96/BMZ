...
<div class="jumbotron">
  <h1 class="display-3">gijang 지도자리</h1>
...
<script>
    $(document).ready(function () {
        ...
        $(".modBtn").on("click", function () {
            formObj.attr("action", "../gijang/modify");
        ...
        $(".delBtn").on("click", function () {
            formObj.attr("action", "../gijang/remove");
            formObj.submit();
        });
        
        // 목록 버튼 클릭시
        $(".listBtn").on("click", function () {
        	formObj.attr("action", "../gijang/gangseo")
        	formObj.attr("method", "get");
        ...
        $(".btnRecommend").on("click",function(){
        	formObj.attr("action","../gijang/recommend")
	       	formObj.attr("method", "get");
        ...
        $(".btnNonRecommend").on("click",function(){
        	formObj.attr("action","../gijang/nonrecommend")
	       	formObj.attr("method", "get");
