...
<div class="jumbotron">
  <h1 class="display-3">donggu지도자리</h1>
...
<script>
    $(document).ready(function () {
        ...
        $(".modBtn").on("click", function () {
            formObj.attr("action", "../donggu/modify");
        ...
        $(".delBtn").on("click", function () {
            formObj.attr("action", "../donggu/remove");
            formObj.submit();
        });
        
        // 목록 버튼 클릭시
        $(".listBtn").on("click", function () {
        	formObj.attr("action", "../donggu/haeundae")
        	formObj.attr("method", "get");
        ...
        $(".btnRecommend").on("click",function(){
        	formObj.attr("action","../donggu/recommend")
	       	formObj.attr("method", "get");
        ...
        $(".btnNonRecommend").on("click",function(){
        	formObj.attr("action","../donggu/nonrecommend")
	       	formObj.attr("method", "get");
