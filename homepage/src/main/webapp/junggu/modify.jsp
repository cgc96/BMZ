...
<script>
	...
	$(document).ready(function () {
	    ...
	    $(".listBtn").on("click", function () {
	        self.location = "../junggu/junggu?page=${criteria.page}&criteria.perPageNum";
...
<div class="jumbotron">
  <h1 class="display-3">junggu지도자리</h1>
  <p class="lead">준희 화이팅 </p>
</div>

 <div class="col-lg-12">
      <form role="form" id ="writeForm" method="post" action ="${path}/junggu/modify">
