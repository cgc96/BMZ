...
<div class="jumbotron">
  <h1 class="display-3">junggu 지도자리</h1>
...
<script>
    $(document).ready(function () {
        ...
        $(".modBtn").on("click", function () {
            formObj.attr("action", "../junggu/modify");
        ...
        $(".delBtn").on("click", function () {
            formObj.attr("action", "../junggu/remove");
            formObj.submit();
        });
        
        // 목록 버튼 클릭시
        $(".listBtn").on("click", function () {
        	formObj.attr("action", "../junggu/junggu")
        	formObj.attr("method", "get");
        ...
        $(".btnRecommend").on("click",function(){
        	formObj.attr("action","../junggu/recommend")
	       	formObj.attr("method", "get");
        ...
        $(".btnNonRecommend").on("click",function(){
        	formObj.attr("action","../junggu/nonrecommend")
	       	formObj.attr("method", "get");
