...
<div class="jumbotron">
  <h1 class="display-3">seogu 지도자리</h1>
...
<script>
    $(document).ready(function () {
        ...
        $(".modBtn").on("click", function () {
            formObj.attr("action", "../seogu/modify");
        ...
        $(".delBtn").on("click", function () {
            formObj.attr("action", "../seogu/remove");
            formObj.submit();
        });
        
        // 목록 버튼 클릭시
        $(".listBtn").on("click", function () {
        	formObj.attr("action", "../seogu/seogu")
        	formObj.attr("method", "get");
        ...
        $(".btnRecommend").on("click",function(){
        	formObj.attr("action","../seogu/recommend")
	       	formObj.attr("method", "get");
        ...
        $(".btnNonRecommend").on("click",function(){
        	formObj.attr("action","../seogu/nonrecommend")
	       	formObj.attr("method", "get");
