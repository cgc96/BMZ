...
<div class="jumbotron">
  <h1 class="display-3">yeonje 지도자리</h1>
...
<script>
    $(document).ready(function () {
        ...
        $(".modBtn").on("click", function () {
            formObj.attr("action", "../yeonje/modify");
        ...
        $(".delBtn").on("click", function () {
            formObj.attr("action", "../yeonje/remove");
            formObj.submit();
        });
        
        // 목록 버튼 클릭시
        $(".listBtn").on("click", function () {
        	formObj.attr("action", "../yeonje/yeonje")
        	formObj.attr("method", "get");
        ...
        $(".btnRecommend").on("click",function(){
        	formObj.attr("action","../yeonje/recommend")
	       	formObj.attr("method", "get");
        ...
        $(".btnNonRecommend").on("click",function(){
        	formObj.attr("action","../yeonje/nonrecommend")
	       	formObj.attr("method", "get");
