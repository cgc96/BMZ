...
<div class="jumbotron">
  <h1 class="display-3">saha 지도자리</h1>
...
<script>
    $(document).ready(function () {
        ...
        $(".modBtn").on("click", function () {
            formObj.attr("action", "../saha/modify");
        ...
        $(".delBtn").on("click", function () {
            formObj.attr("action", "../saha/remove");
            formObj.submit();
        });
        
        // 목록 버튼 클릭시
        $(".listBtn").on("click", function () {
        	formObj.attr("action", "../saha/gangseo")
        	formObj.attr("method", "get");
        ...
        $(".btnRecommend").on("click",function(){
        	formObj.attr("action","../saha/recommend")
	       	formObj.attr("method", "get");
        ...
        $(".btnNonRecommend").on("click",function(){
        	formObj.attr("action","../saha/nonrecommend")
	       	formObj.attr("method", "get");
