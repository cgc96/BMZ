...
<script>
   $(function(){
      $("#listbtn").click(function(){
         location.href='../geumjeong/geumjeong';
      })
   })
</script>
...
<script>
 ...
 <div class="col-lg-12">
      <form role="form" id ="writeForm" method="post" action ="../geumjeong/write">
         <div class="box box-primary">
               ...
               <div class="map_wrap">
                <div id="mapp" style="width:50%;height:100%;position:relative;overflow:hidden;"></div>
                  <div id="menu_wrap" class="bg_white">
			        <div class="option">
			            <div>
			                    키워드 : <input type="text" value="금정구 맛집" id="keyword" size="15"> 
            ...
            var mapContainer = document.getElementById('mapp'), // 지도를 표시할 div 
                mapOption = {
                    center: new kakao.maps.LatLng(35.230988, 129.087399), // 지도의 중심좌표
                    level: 3 // 지도의 확대 레벨
                };  
