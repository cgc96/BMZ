  ...
  <div class="box box-primary">
       	...
       	<div class ="text-center">
       		<ul class="pagination">
       			<c:if test="${pageMaker.prev}" >
					...
					<li><a href="./geumjeong${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
				</c:if>
				<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage }" var="idx">
					<c:if test = "${pageMaker.criteria.page == idx}">
					  <li class= "page-item active">
							<a class="page-link" href="./geumjeong${pageMaker.makeQuery(idx)}">${idx}</a>
						</li>
					</c:if>
					<c:if test = "${pageMaker.criteria.page != idx}">
					  <li class= "page-item">
				...
				<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
					...
					<li><a href="./geumjeong${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
				</c:if>
       		</ul>
       	</div>
       </div>
    <div class="box-footer">
       <div class="pull-right">
           <form action = "../geumjeong/write" method = "Get">
      			<%
