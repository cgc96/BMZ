...
<script>
    $(document).ready(function () {
        ...
        $(".modBtn").on("click", function () {
            formObj.attr("action", "../geumjeong/modify");
        ...
        $(".delBtn").on("click", function () {
            ...
            formObj.attr("action", "../geumjeong/remove");
            formObj.submit();
        });
        
        // 목록 버튼 클릭시
        $(".listBtn").on("click", function () {
        	formObj.attr("action", "../geumjeong/geumjeong")
        	formObj.attr("method", "get");
        ...
        $(".btnRecommend").on("click",function(){
        	formObj.attr("action","../geumjeong/recommend")
	       	formObj.attr("method", "get");
        ...
        $(".btnNonRecommend").on("click",function(){
        	formObj.attr("action","../geumjeong/nonrecommend")
	       	formObj.attr("method", "get");
