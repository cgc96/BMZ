    ...
    <div class="post replyDiv" data-replyNo={{replyNo}}>
        <div class="user-block">
            ...
            <span class="username">
                ...
                {{replyWriter}}</a>
                <%--댓글 삭제 버튼--%>
                <button type="button" class = "btn btn-xs btn-success modalModBtn">
				 댓글 삭제
				</button>
                <%--댓글 수정 버튼--%>
                <button type="button" class = "btn btn-xs btn-success modalDelBtn">
				 댓글 수정
				</button>
            </span>
            <%--댓글 작성일자--%>
...
<script>
    $(document).ready(function () {
        ...
        $(".modBtn").on("click", function () {
            formObj.attr("action", "../gangseo/modify");
        ...
        $(".delBtn").on("click", function () {
            formObj.attr("action", "../gangseo/remove");
            formObj.submit();
        });
        
        // 목록 버튼 클릭시
        $(".listBtn").on("click", function () {
        	formObj.attr("action", "../gangseo/gangseo")
        	formObj.attr("method", "get");
        ...
        $(".btnRecommend").on("click",function(){
        	formObj.attr("action","../gangseo/recommend")
	       	formObj.attr("method", "get");
        ...
        $(".btnNonRecommend").on("click",function(){
        	formObj.attr("action","../gangseo/nonrecommend")
	       	formObj.attr("method", "get");
