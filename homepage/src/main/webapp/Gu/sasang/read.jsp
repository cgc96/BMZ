...
<div class="jumbotron">
  <h1 class="display-3">sasang 지도자리</h1>
...
<script>
    $(document).ready(function () {
        ...
        $(".modBtn").on("click", function () {
            formObj.attr("action", "../sasang/modify");
        ...
        $(".delBtn").on("click", function () {
            formObj.attr("action", "../sasang/remove");
            formObj.submit();
        });
        
        // 목록 버튼 클릭시
        $(".listBtn").on("click", function () {
        	formObj.attr("action", "../sasang/sasang")
        	formObj.attr("method", "get");
        ...
        $(".btnRecommend").on("click",function(){
        	formObj.attr("action","../sasang/recommend")
	       	formObj.attr("method", "get");
        ...
        $(".btnNonRecommend").on("click",function(){
        	formObj.attr("action","../sasang/nonrecommend")
	       	formObj.attr("method", "get");
