...
<div class="jumbotron">
  <h1 class="display-3">suyeong지도자리</h1>
...
<script>
    $(document).ready(function () {
        ...
        $(".modBtn").on("click", function () {
            formObj.attr("action", "../suyeong/modify");
        ...
        $(".delBtn").on("click", function () {
            formObj.attr("action", "../suyeong/remove");
            formObj.submit();
        });
        
        // 목록 버튼 클릭시
        $(".listBtn").on("click", function () {
        	formObj.attr("action", "../suyeong/suyeong")
        	formObj.attr("method", "get");
        ...
        $(".btnRecommend").on("click",function(){
        	formObj.attr("action","../suyeong/recommend")
	       	formObj.attr("method", "get");
        ...
        $(".btnNonRecommend").on("click",function(){
        	formObj.attr("action","../suyeong/nonrecommend")
	       	formObj.attr("method", "get");
