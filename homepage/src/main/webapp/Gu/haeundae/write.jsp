...
<script>
   $(function(){
      $("#listbtn").click(function(){
         location.href='../haeundae/haeundae';
      })
   })
</script>
...
<script>
 ...
 <div class="col-lg-12">
      <form role="form" id ="writeForm" method="post" action ="../haeundae/write">
         <div class="box box-primary">
            ...
            var mapContainer = document.getElementById('mapp'), // 지도를 표시할 div 
                mapOption = {
                    center: new kakao.maps.LatLng(35.171747, 129.175554), // 지도의 중심좌표
                    level: 3 // 지도의 확대 레벨
                };  
