...
<div class="jumbotron">
  <h1 class="display-3">yeongdo 지도자리</h1>
...
<script>
    $(document).ready(function () {
        ...
        $(".modBtn").on("click", function () {
            formObj.attr("action", "../yeongdo/modify");
        ...
        $(".delBtn").on("click", function () {
            formObj.attr("action", "../yeongdo/remove");
            formObj.submit();
        });
        
        // 목록 버튼 클릭시
        $(".listBtn").on("click", function () {
        	formObj.attr("action", "../yeongdo/yeongdo")
        	formObj.attr("method", "get");
        ...
        $(".btnRecommend").on("click",function(){
        	formObj.attr("action","../yeongdo/recommend")
	       	formObj.attr("method", "get");
        ...
        $(".btnNonRecommend").on("click",function(){
        	formObj.attr("action","../yeongdo/nonrecommend")
	       	formObj.attr("method", "get");
