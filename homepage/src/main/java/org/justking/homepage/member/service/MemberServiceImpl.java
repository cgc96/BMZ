...
public class MemberServiceImpl implements MemberService {
	...
	public void send_mail(MemberDTO member, String div) throws Exception {
		...
		String hostSMTPid = "rnrcjf00@naver.com";
		String hostSMTPpwd = "@just@king1";
		
		// 보내는 사람 EMail, 제목, 내용
		String fromEmail = "rnrcjf00@naver.com";
		...
		if(div.equals("join")) {
			...
			msg += "<div align = 'center' style = 'border:1px solid black; font-family:verdana'>";
			msg += "<h3 style - 'color: blue;'>";
			msg += member.getId() + "님의 임시 비밀번호 입니다. 비밀번호를 변경하여 사용하세.</h3>";
			msg += "<p>임시 비밀번호 : ";
