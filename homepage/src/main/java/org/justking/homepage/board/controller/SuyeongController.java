...
@Controller
@RequestMapping("/suyeong/*")
public class SuyeongController {
private static final Logger logger = LoggerFactory.getLogger(BoardController.class);
	
	private final BoardService boardService;
	
	@Inject
	public SuyeongController(BoardService boardService) {
	...
	public String nonrecommend(@RequestParam int articleNo, RedirectAttributes redirectAttributes) throws Exception{
		...
		return "redirect:/suyeong/suyeong";
	}
	// 게시물 추천 관련 메소드
