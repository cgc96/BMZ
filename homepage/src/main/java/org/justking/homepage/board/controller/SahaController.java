...
private static final Logger logger = LoggerFactory.getLogger(BoardController.class);
	...
	@Inject
	public SahaController(BoardService boardService) {
...
//	}	
	...
	//강서구 게시판 페이지
	@RequestMapping(value = "/saha", method = RequestMethod.GET)
	public String geumjeong(Model model, Criteria criteria) throws Exception{
		...
		model.addAttribute("boards",boardService.sahalistCriteria(criteria));
