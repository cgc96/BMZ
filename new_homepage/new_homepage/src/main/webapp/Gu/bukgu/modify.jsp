...
<script>
	...
	$(document).ready(function () {
	    ...
	    $(".listBtn").on("click", function () {
	        self.location = "../bukgu/bukgu?page=${criteria.page}&criteria.perPageNum";
...
<div class="jumbotron">
  <h1 class="display-3">bukgu 지도자리</h1>
  <p class="lead">준희 화이팅 </p>
</div>

 <div class="col-lg-12">
      <form role="form" id ="writeForm" method="post" action ="${path}/Gu/bukgu/modify">
